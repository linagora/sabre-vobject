...
ICS
        ...
        $this->parse($oldMessage, $newMessage, $expected, 'mailto:sharee@example.org', ['mailto:sharee@example.org']);
...
ICS;
        ...
        $this->parse($oldMessage, $newMessage, $expected, 'mailto:sharee@example.org', ['mailto:sharee2@example.org']);
